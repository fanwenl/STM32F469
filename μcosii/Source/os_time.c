...
void  OSTimeDly (INT32U ticks)
{
    ...
    /*取消当前任务的就绪标志，更新OSTCBDly，进行一次任务调度*/
...
*
* Arguments  : ticks      specifies the new value that  needs to take.
*
* Returns    : none
*********************************************************************************************************
*/
