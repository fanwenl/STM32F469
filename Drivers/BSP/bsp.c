...
* ************************************************************************************************
 */
uint8_t TS_IO_ReadMultiple(uint8_t Addr, uint16_t Reg, uint16_t MemAddSize, uint8_t *Buffer, uint16_t Length)
{
	return I2C1_ReadMultiple(Addr, Reg, MemAddSize, Buffer, Length);
}
/*
**************************************************************************************************
*描述：触摸IO写多个数据函数
...
* ************************************************************************************************
 */
uint8_t TS_IO_WriteMultiple(uint8_t Addr, uint16_t Reg, uint16_t MemAddSize, uint8_t *Buffer, uint16_t Length)
{
	 return I2C1_WriteMultiple(Addr, Reg, MemAddSize, Buffer, Length);
}
/*
**********************************************************************************************************
*												Audio接口函数
